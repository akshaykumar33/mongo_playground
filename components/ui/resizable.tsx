...
function ResizablePanelGroup({
  ...
  direction,
  ...props
}: React.ComponentProps<typeof Group> & { className?: string; direction?: "horizontal" | "vertical" }) {
  return (
    <Group
...
function ResizableHandle({
  ...
  return (
    <Separator
      ...
      className={cn(
        "bg-border focus-visible:ring-ring relative flex w-px items-center justify-center after:absolute after:inset-y-0 after:left-1/2 after:w-4 after:-translate-x-1/2 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-hidden",
